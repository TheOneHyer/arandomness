...
"""Test arandomness' copen function from files subpackage

Copyright:
    test_copen.py  test arandomness' copen function from files subpackage
...
from arandomness.files import copen
import bz2
import gzip
import lzma
